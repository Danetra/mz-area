...
const List = () => {
  return (
    <div className="bg-[#EFEFEF] h-full">
      <NavbarProducts />
      <div className="flex">
        <div className="filter px-[50px] py-[50px] md:block sm:hidden">
        ...
        <div className="flex lg:flex-wrap sm:flex- lg:mt-8 md:mt-8">
          {/* Sample Card (Repeat this for other cards) */}
          ...
          <div className="w-1/3 p-[50px] mt-[-30px] ml-[-30px]">
            <div className="w-full h-30 md:w-full md:h-30 rounded-[20px] overflow-hidden shadow-lg cursor-pointer">
              <img className="w-full h-25" src={product1} alt="Product" />
              <div className="px-6 py-2 mt-2">
                <div className="font-mzarea text-xl mb-2">
